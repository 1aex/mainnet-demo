...
// node_modules/blockstore-core/node_modules/multiformats/dist/src/bases/base36.js
var base36 = baseX({
  prefix: "k",
  name: "base36",
...
var MemoryBlockstore = class extends BaseBlockstore {
  ...
  async *getAll(options) {
    ...
    for (const [key, value] of this.data.entries()) {
      yield {
        cid: CID.createV1(code, decode4(base32.decode(key))),
        block: value
      };
      options?.signal?.throwIfAborted();
    }
...
var TieredBlockstore = class extends BaseBlockstore {
  ...
  async *getAll(options) {
    ...
    yield* src_default2(src_default(...this.stores.map((s) => s.getAll(options))), (pair) => {
...
//# sourceMappingURL=chunk-266XOBJX.js.map
