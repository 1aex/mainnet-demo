...
var ascii = createCodec("ascii", "a", (buf) => {
  ...
  for (let i3 = 0; i3 < buf.length; i3++) {
    string3 += String.fromCharCode(buf[i3]);
  }
  return string3;
}, (str) => {
  str = str.substring(1);
...
function fromString3(string3, encoding = "utf8") {
  ...
  return base.decoder.decode(`${base.prefix}${string3}`);
}
...
function qc(t, e) {
  ...
  return oo({ type: Bt(n2.type), senderPublicKey: typeof n2.senderPublicKey < "u" ? toString2(n2.senderPublicKey, G) : void 0, receiverPublicKey: e?.receiverPublicKey });
}
function oo(t) {
  const e = t?.type || dn;
  if (e === Ft) {
...
function zc(t, e) {
  ...
  if (!_c.verify(concat3([s, c3]), u3, l3)) throw new Error("Invalid signature");
  return sn(t).payload;
}
var so = "irn";
function Zc(t) {
...
function createCodec2(name, prefix, encode4, decode2) {
  return {
    name,
    prefix,
    encoder: {
...
var vi2 = class {
  constructor(e, t, i3) {
    this.core = e, this.logger = t, S2(this, "name", Tt2), S2(this, "keychain"), S2(this, "randomSessionIdentifier", jc()), S2(this, "initialized", false), S2(this, "init", async () => {
      ...
      const o2 = Se({ encoded: s, encoding: n2 });
      return o2.senderPublicKey ? toString3(o2.senderPublicKey, G) : void 0;
...
var D2 = async () => {
  const { createAppKit: s } = await import("./core-ORCV2OHV.js");
  return s;
};
...
*/
//# sourceMappingURL=index.es-YNABWDLR.js.map
